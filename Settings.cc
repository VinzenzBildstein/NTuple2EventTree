...
Settings::Settings(std::string fileName, int verbosityLevel)
    ...
    fTimeWindow[9000].resize(5,std::vector<double>(1));
	 ...
	 double A, B, C;
	 for(int i = 1; i <= 4; i++) {
		 fProtonCoeff[i-1] = env.GetValue(Form("Descant.Proton.%d", i), 0.0);
		 fDeuteronCoeff[i-1] = env.GetValue(Form("Descant.Deuteron.%d", i), 0.0);
		 fCarbonCoeff[i-1] = env.GetValue(Form("Descant.Carbon.%d", i), 0.0);
		 fBeCoeff[i-1] = env.GetValue(Form("Descant.Be.%d", i), 0.0);
		 fBCoeff[i-1] = env.GetValue(Form("Descant.B.%d", i), 0.0);
		 fAlphaCoeff[i-1] = env.GetValue(Form("Descant.Alpha.%d", i), 0.0);
	 }
	 double defaultA = env.GetValue("Descant.Resolution.A", 0.15);
	 double defaultB = env.GetValue("Descant.Resolution.B", 0.10);
	 double defaultC = env.GetValue("Descant.Resolution.C", 0.02);
	 for(int detector = 0; detector < 15; ++detector) {
		 A = env.GetValue(Form("Descant.Blue.%d.Resolution.A", detector), defaultA);
		 B = env.GetValue(Form("Descant.Blue.%d.Resolution.B", detector), defaultB);
		 C = env.GetValue(Form("Descant.Blue.%d.Resolution.C", detector), defaultC);
		 fResolution[8010][detector].push_back(TF1(Form("Descant.Blue.%d.Resolution", detector), Form("x*TMath::Sqrt(TMath::Power(%f,2)+TMath::Power(%f,2)/x+TMath::Power(%f/x,2))",A,B,C),0.,20.));
	 ...
	 for(int detector = 0; detector < 10; ++detector) {
		 A = env.GetValue(Form("Descant.Green.%d.Resolution.A", detector), defaultA);
		 B = env.GetValue(Form("Descant.Green.%d.Resolution.B", detector), defaultB);
		 C = env.GetValue(Form("Descant.Green.%d.Resolution.C", detector), defaultC);
		 fResolution[8020][detector].push_back(TF1(Form("Descant.Green.%d.Resolution", detector), Form("x*TMath::Sqrt(TMath::Power(%f,2)+TMath::Power(%f,2)/x+TMath::Power(%f/x,2))",A,B,C),0.,20.));
	 ...
	 for(int detector = 0; detector < 15; ++detector) {
		 A = env.GetValue(Form("Descant.Red.%d.Resolution.A", detector), defaultA);
		 B = env.GetValue(Form("Descant.Red.%d.Resolution.B", detector), defaultB);
		 C = env.GetValue(Form("Descant.Red.%d.Resolution.C", detector), defaultC);
		 fResolution[8030][detector].push_back(TF1(Form("Descant.Red.%d.Resolution", detector), Form("x*TMath::Sqrt(TMath::Power(%f,2)+TMath::Power(%f,2)/x+TMath::Power(%f/x,2))",A,B,C),0.,20.));
	 ...
	 for(int detector = 0; detector < 20; ++detector) {
		 A = env.GetValue(Form("Descant.White.%d.Resolution.A", detector), defaultA);
		 B = env.GetValue(Form("Descant.White.%d.Resolution.B", detector), defaultB);
		 C = env.GetValue(Form("Descant.White.%d.Resolution.C", detector), defaultC);
		 fResolution[8040][detector].push_back(TF1(Form("Descant.White.%d.Resolution", detector), Form("x*TMath::Sqrt(TMath::Power(%f,2)+TMath::Power(%f,2)/x+TMath::Power(%f/x,2))",A,B,C),0.,20.));
	 ...
	 for(int detector = 0; detector < 10; ++detector) {
		 A = env.GetValue(Form("Descant.Yellow.%d.Resolution.A", detector), defaultA);
		 B = env.GetValue(Form("Descant.Yellow.%d.Resolution.B", detector), defaultB);
		 C = env.GetValue(Form("Descant.Yellow.%d.Resolution.C", detector), defaultC);
		 fResolution[8050][detector].push_back(TF1(Form("Descant.Yellow.%d.Resolution", detector), Form("x*TMath::Sqrt(TMath::Power(%f,2)+TMath::Power(%f,2)/x+TMath::Power(%f/x,2))",A,B,C),0.,20.));
